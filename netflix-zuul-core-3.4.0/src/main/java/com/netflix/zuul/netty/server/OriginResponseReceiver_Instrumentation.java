...
@Weave(type = MatchType.BaseClass, originalName = "com.netflix.zuul.netty.server.OriginResponseReceiver")
public abstract class OriginResponseReceiver_Instrumentation {
