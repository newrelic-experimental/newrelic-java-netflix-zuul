...
@Weave(type = MatchType.BaseClass, originalName = "com.netflix.zuul.netty.filter.BaseZuulFilterRunner")
public abstract class BaseZuulFilterRunner_Instrumentation<I extends ZuulMessage, O extends ZuulMessage> {
	...
	@Trace
	protected FilterExecutionResult<O> executeFilter(ZuulFilter_instrumentation<I, O> filter, I inMesg)  {
	...
	@Trace
	 ...
	 @Weave(originalName = "com.netflix.zuul.netty.filter.BaseZuulFilterRunner$FilterExecutionResult")
	 protected static class FilterExecutionResult<O> {
